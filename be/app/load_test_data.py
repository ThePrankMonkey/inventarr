...
def create_demo_data():
        ...
        item_1 = add_and_commit(Item(name="WaveShare 2.7in EPaper Display", quantity=1, room_id=room_1.id, chest_id=chest_1.id, pocket_id=pocket_1.id))
        ...
        item_2 = add_and_commit(Item(name="All Purpose Flour", quantity=1, room_id=room_2.id, chest_id=chest_2.id, pocket_id=pocket_2.id))
